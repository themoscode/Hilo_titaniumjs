...
;(function () {
  ...
  DSA.createInWebWorker = function (options, cb) {
	...
	//console.log(worker);
	var worker = new pseudoWorker(this)
...
;(function () {
  ...
  AKE.prototype = {
    ...
    sendMsg: function (version, type, msg) {console.log('ORT: sendMESSAGE');
...
;(function () {
  ...
  OTR.prototype.receiveMsg = function (msg, recall) {
	...
	console.log('trigger inco: ui');
	//TEMP
	//if(typeof recall==='function') recall([msg.msg, !!msg.encrypted]);
  }
