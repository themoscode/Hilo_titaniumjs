...
Cryptocat.xmpp.defaultDomain = 'hilo.im'
Cryptocat.xmpp.defaultConferenceServer = 'conference.'+Cryptocat.xmpp.defaultDomain
Cryptocat.xmpp.defaultRelay = 'http://'+Cryptocat.xmpp.defaultDomain+'/http-bind/'
...
console.log(Cryptocat.xmpp.domain);
...
Cryptocat.xmpp.sendPublicKey = function(nickname) {
	console.log('sendPublicKey to: '+nickname);
