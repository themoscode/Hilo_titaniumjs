...
//NOT NEEDED $('#version').text(Cryptocat.version)
...
Cryptocat.addToConversation = function(message, nickname, conversation, type) {
	//QUICK&DIRTY
	console.log('QUICK&DIRTY');
	console.log(message);
	hiloClient.options.messageReceivedCallback(message, nickname, conversation, type);
	return;
	console.log(type);
	console.log(message);
...
Cryptocat.removeAuthAndWarn = function(nickname) {
	...
	console.log('remove AUTH and ARN');
	return false;
	var openAuth = false
